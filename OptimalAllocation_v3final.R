...
setwd("/Users/silverk/Silver_K/Exeter_Health_Data_Science/HPDM099_Research Project/Temp")
...
# 2.1 read data
x1<-read_excel("inputs_core_seg.xlsx",sheet="attributes")
x2<-read_excel("inputs_core_seg.xlsx",sheet="activity")
x3<-read_excel("inputs_core_seg.xlsx",sheet="cost")
